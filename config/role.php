        ...
        "value" => [
            ...
            "value" => [
                ...
                [
                    ...
                    "value" => "ROLE_DASHBOARD_SERVICES_SHOW",
                    "disabled" => false
                ],
                [
                    "label" => "Information lettre",
                    "value" => "ROLE_DASHBOARD_LETTERS_SHOW",
                    "disabled" => false
                ]
            ]
        ]
    ...
    [
        ...
        "value" => [
            ...
            "value" => [
                [
                    "label" => "role.menu",
                    "value" => "ROLE_USERS_MENU",
                    "disabled" => false
                ],
                [
                    "label" => "role.show",
                    "value" => "ROLE_USERS_SHOW",
                    "disabled" => false
                ],
                [
                    "label" => "role.saving",
                    "value" => "ROLE_USERS_CREATE",
                    "disabled" => false,
                ],
                [
                    "label" => "role.edit",
                    "value" => "ROLE_USERS_EDIT",
                    "disabled" => false,
                ],
                [
                    "label" => "role.delete",
                    "value" => "ROLE_USERS_DESTROY",
                    "disabled" => false,
                ],
                [
                    "label" => "role.trash",
