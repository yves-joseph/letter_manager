...
@section('main')
    <div class="row">
        @if(\Illuminate\Support\Facades\Gate::allows('granted', 'ROLE_DASHBOARD_USERS_SHOW'))
            <div class="col-12 col-md-4">
                <x-display>
                    <div class="resume_view">
                        ...
                        <p>
                            vous avez {{ \App\Models\User::query()->count() }} utilisateur(s) dans votre base de
                            données.
        ...
        @endif
        @if(\Illuminate\Support\Facades\Gate::allows('granted', 'ROLE_DASHBOARD_SERVICES_SHOW'))
            <div class="col-12 col-md-4">
                <x-display>
                    <div class="resume_view">
                        <div class="resume_view-icon">
        ...
        @endif
        @if(\Illuminate\Support\Facades\Gate::allows('granted', 'ROLE_DASHBOARD_LETTERS_SHOW'))
            <div class="col-12 col-md-4">
                <x-display>
                    <div class="resume_view">
                        <div class="resume_view-icon">
        ...
        <div class="col-12 col-md-8">
            <x-display>
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="col-auto">
                        <a style="text-decoration: none;text-transform: uppercase;font-weight: 600;"
                           href="{{ route('letters.index') }}">Voir plus</a>
                    </div>
                </div>
